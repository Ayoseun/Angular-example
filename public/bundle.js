...
`;
  ...
  <div class="bottom-section" id="bottom-section">
                ...
                <div class="dropdown-content">
                    ...
                    <div class="crypto-container">
                        ...
                        <div class="crypto-form-field">
                            <label for="country">Pay with</label>
                            <div class="crypto-input-wrapper">
                                <select style="color: #9499A1; font-size: 8px;">
                                    <option>Select cryptocurrency network</option>
                        ...
                        <button style="background-color: #2e7d32;">Connect wallet</button>

                        <h1>Pay with ethereum</h1>
                        <p>To complete this payment for REF 4578, send exactly 15.7500 ETH to the address below</p>
                        <div class="qr-code">
                            <img src="/api/placeholder/200/200" alt="QR Code">
                        </div>
                        <p class="address">0x742d35Cc6634C0532925a3b844Bc454e4438f44e</p>
                        <p class="warning">Please make sure to only send ETH to this address</p>
                        <div class="payment-details">
                            <p><span class="ethereum-icon"></span>Amount to due: 15</p>
                            <p>Address: 0x742d35Cc...</p>
                            <p>Remaining time: <span class="timer">00:26:20</span></p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="dropdown" id="dropdown-3">
                ...
                <div class="dropdown-content">Content for Option 3</div>
            </div>
            <div class="dropdown" id="dropdown-4">
                ...
                <div class="dropdown-content">Content for Option 4</div>
            </div>
        </div>
